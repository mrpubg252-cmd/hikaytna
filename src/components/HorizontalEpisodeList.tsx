              ...
              <div className="relative w-full aspect-[16/9] bg-zinc-900 overflow-hidden shrink-0 border-b border-white/[0.02]">
                {seriesImage ? (
                  <img
                    ...
                    src={seriesImage}
                    alt={displayTitle}
                    className="w-full h-full object-cover object-[center_top] opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-300 pointer-events-none"
                    onError={(e) => {

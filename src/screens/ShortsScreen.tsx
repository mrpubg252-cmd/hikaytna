                ...
                <div className="space-y-4">
                  ...
                  <div className="group space-y-2">
                    <label className="text-[11px] font-black text-white uppercase tracking-widest flex items-center gap-2">
                      ...
                      عنوان اللقطة الحماسية <span className="text-primary">*</span>
                    </label>
                    <div className="relative group-focus-within:scale-[1.01] transition-transform">
                      <textarea
                        ...
                        className="w-full bg-black/60 border border-white/10 rounded-2xl p-4 text-right text-xs text-white focus:outline-none focus:border-primary/50 placeholder:text-zinc-700 font-bold resize-none transition-all scrollbar-hide"
                      />
                      <div className="absolute bottom-3 left-3 text-[9px] font-bold text-zinc-600">
                  ...
                  {/* Visual Style Tag */}
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-white/40 uppercase tracking-widest px-2">نوع اللقطة</label>
                    <div className="flex flex-wrap gap-2">
                      {[
                        { val: 'لقطة حاسمة 🔥', color: 'border-orange-500/30 text-orange-400 bg-orange-500/5' },
                        { val: 'أكشن مدمر ⚔️', color: 'border-blue-500/30 text-blue-400 bg-blue-500/5' },
                        { val: 'لحظة حزينة 💔', color: 'border-red-500/30 text-red-400 bg-red-500/5' },
                        { val: 'نهاية صادمة 😱', color: 'border-amber-500/30 text-amber-400 bg-amber-500/5' },
                      ].map((tag) => (
                        <button
                          key={tag.val}
                          type="button"
                          onClick={() => setPubTag(tag.val)}
                          className={cn(
                            "px-4 py-2 rounded-full text-[10px] font-black transition-all border whitespace-nowrap",
                            pubTag === tag.val ? "bg-white text-black border-white shadow-[0_0_20px_rgba(255,255,255,0.2)]" : tag.color
                          )}
                        >
                          {tag.val}
                        </button>

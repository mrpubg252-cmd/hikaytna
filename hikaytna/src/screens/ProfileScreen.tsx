             ...
             <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
              ...
              <div className="text-center md:text-right space-y-2">
                <div className="flex flex-col md:flex-row items-center gap-2 justify-center md:justify-start">
                  <h1 className="text-3xl font-black italic tracking-tighter text-white">{currentName}</h1>
                  {adRemovalActive && (
                    <span className="bg-amber-500 text-black text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full select-none shadow-[0_0_12px_#f59e0b] flex items-center gap-1">

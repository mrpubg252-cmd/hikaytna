        ...
        {displayedEpisodes.map(({ ep, originalIndex }) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group text-right relative bg-[#09090c]/80 hover:bg-zinc-900 border rounded-xl p-2 transition-all duration-200 flex items-center gap-2.5 w-full outline-none cursor-pointer focus:ring-2 focus:ring-primary focus:border-primary focus:bg-primary/10 focus:scale-[1.01]",
                isActive
